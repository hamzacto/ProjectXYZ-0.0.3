...
GuidedAgentModal.Content = Content;
GuidedAgentModal.Header = Header;
GuidedAgentModal.Trigger = Trigger;
GuidedAgentModal.Footer = Footer;
export default GuidedAgentModal;
